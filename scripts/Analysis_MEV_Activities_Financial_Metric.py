...
def generate_boxplot(ax, data, ylabel):
...
generate_boxplot(ax1, profit_data, 'Profit(ETH)')
plt.tight_layout()
...
generate_boxplot(ax2, profit_margin_data, 'Profit Margin(%)')
plt.tight_layout()
...
generate_boxplot(ax3, revenue_data, 'Revenue(ETH)')
plt.tight_layout()
